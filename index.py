...
re_parametros = r"\d+[\s\r\n\-]*(?:semana(?:l|is)|mensa(?:l|is)|trimestra(?:l|is)|bimestra(?:l|is)|anua(?:l|is))"
...
dfs = tabula.read_pdf("./amostragem/teste.pdf", pages='all', encoding="latin-1", lattice=True)
...
#         #     summary_structure["data"] = re.findall(re_extract_date, data[i+3], re.IGNORECASE)[0]
